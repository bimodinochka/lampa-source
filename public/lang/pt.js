export default {
    ...
    settings_cub_sync_descr: 'Sincronização com serviço TUB: favoritos, histórico de navegação, tags e retomar reprodução.',
    ...
    settings_cub_sync_btn_descr: 'Guardar favoritos na conta TUB',
    ...
    plugins_load_from: 'Carregado do TUB',
    ...
    account_create: 'Descubra mais oportunidades com uma conta TUB. Registe-se em <span class="account-modal__site">{site}</span> e tenha acesso para sincronizar seus favoritos, tempos visualizados e outros recursos da conta TUB.',
    account_premium: 'Descubra mais recursos com uma conta TUB Premium. Aumentando limites e acesso a recursos adicionais do serviço.',
    account_premium_more: 'Saiba mais sobre TUB Premium',
    account_limited: 'Você atingiu o limite máximo. Aumente o limite com uma conta TUB Premium. Saiba mais em <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: 'Instalado do TUB',
    ...
    change_source_on_cub: 'Alterar fonte para TUB',
    ...
    ad_disable: 'Ao assinar o TUB Premium, você esquecerá a publicidade.',
    ...
    ai_search_limit: 'Limite de solicitações excedido. Tente novamente mais tarde. Com a assinatura TUB Premium, os limites serão aumentados e você não precisará esperar!',
    ai_subscribe_title: 'Desbloqueie mais possibilidades com a IA',
    ai_subscribe_descr: 'Assine o TUB Premium e aumente o número de solicitações para a IA. Junto com a IA, encontraremos os melhores filmes para você.',
