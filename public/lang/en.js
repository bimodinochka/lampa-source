export default {
    ...
    settings_cub_sync_descr: 'Synchronization with the TUB service: Synchronization of your bookmarks, browsing history, tags and timecodes.',
    ...
    settings_cub_sync_btn_descr: 'Save local bookmarks to TUB account',
    ...
    plugins_load_from: 'Loaded from TUB',
    ...
    account_create: 'Discover more opportunities with a TUB account. Register at <span class="account-modal__site">{site}</span> and get access to sync your bookmarks, timecodes and other TUB account features.',
    account_premium: 'Discover more features with a TUB Premium account. Increasing limits and access to additional features of the service.',
    account_premium_more: 'Learn more about TUB Premium',
    account_limited: 'You have reached the maximum limit. Increase the limit with a TUB Premium account. Learn more at <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: 'Installed from TUB',
    ...
    change_source_on_cub: 'Change source to TUB',
    ...
    ad_disable: 'By subscribing to TUB Premium, you will forget about advertising.',
    ...
    ai_search_limit: 'Request limit exceeded. Please try again later. With a TUB Premium subscription, limits will be increased, and you won’t have to wait!',
    ai_subscribe_title: 'Unlock More Opportunities with AI',
    ai_subscribe_descr: 'Subscribe to TUB Premium and increase the number of requests to AI. Together with AI, we’ll find the best movies for you.',
