export default {
    ...
    settings_cub_sync_descr: 'Синхронизация с сервисом TUB: синхронизация ваших закладок, истории просмотров, меток и тайм-кодов.',
    ...
    settings_cub_sync_btn_descr: 'Сохранить локальные закладки в аккаунт TUB',
    ...
    lampa_movie_descr: 'Следите за новинками на своем смартфоне. <br>Телеграм: <b>@tub_movie</b>',
    ...
    plugins_load_from: 'Загружено из TUB',
    ...
    account_create: 'Откройте больше возможностей с аккаунтом TUB. Зарегистрируйтесь на сайте <span class="account-modal__site">{site}</span> и получите доступ к синхронизации ваших закладок, тайм-кодов и других возможностей аккаунта TUB.',
    account_premium: 'Раскройте новые горизонты с аккаунтом TUB Premium! Наслаждайтесь увеличенными лимитами и обогащенным функционалом сервиса. Дополнительные возможности ждут вас уже сегодня!',
    account_premium_more: 'Подробнее о TUB Premium',
    account_limited: 'Вы достигли максимального лимита. Увеличьте лимит с аккаунтом TUB Premium. Подробнее на сайте <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: 'Установленные из TUB',
    ...
    change_source_on_cub: 'Сменить источник на TUB',
    ...
    ad: 'Реклама',
    ad_disable: 'Подписавшись на TUB Premium, вы забудете о рекламе.',
    ...
    ai_search_limit: 'Лимит запросов превышен. Попробуйте повторить запрос позже. С подпиской TUB Premium лимиты будут увеличены, и вам не придется ждать!',
    ai_subscribe_title: 'Откройте бошьше возможностей с AI',
    ai_subscribe_descr: 'Оформите подписку TUB Premium и увеличте количество запросов к AI. Вместе с AI мы подберем вам лучшие фильмы которые только сможем.',
