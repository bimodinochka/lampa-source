export default {
    ...
    account_create: '使用 TUB 帐户发现更多机会。 在 <span class="account-modal__site">{site}</span> 注册并获得同步您的书签、时间码和其他 TUB 帐户功能的权限。',
    account_premium: '使用 TUB Premium 帐户发现更多功能。 增加对服务附加功能的限制和访问权限。',
    account_premium_more: '了解有关 TUB 高级版的更多信息',
    ...
    account_limited: '您已达到最大限制。 使用 TUB Premium 帐户提高限制。 在 <span class="account-modal__site">{site}/premium</span> 了解更多信息',
    ...
    change_source_on_cub: '将源更改为 TUB',
    ...
    ad_disable: '通过订阅 TUB Premium，您将不受广告打扰。',
    ad_after: '广告通过',
    ad: '广告',
    ad_skip: '跳过',
