export default {
    ...
    settings_cub_sync_descr: 'Сінхранізацыя з сэрвісам TUB: сінхранізацыя вашых закладак, гісторыі праглядаў, пазнак і тайм-кодаў.',
    ...
    settings_cub_sync_btn_descr: 'Захаваць лакальныя закладкі ў рахунак TUB',
    ...
    lampa_movie_descr: 'Сачыце за навінкамі на сваім смартфоне. <br>Тэлеграм: <b>@tub_movie</b>',
    ...
    plugins_load_from: 'Загружана з TUB',
    ...
    account_create: 'Адкрыйце больш магчымасцяў з акаўнтам TUB. Зарэгіструйцеся на сайце <span class="account-modal__site">{site}</span> і атрымайце доступ да сінхранізацыі вашых закладак, тайм-кодаў і іншых магчымасцяў акаўнта TUB.',
    account_premium: 'Раскрыйце новыя гарызонты з акаўнтам TUB Premium! Атрымлівайце асалоду ад павялічанымі лімітамі і ўзбагачаным функцыяналам сэрвісу. Дадатковыя магчымасці чакаюць вас ужо сёння!',
    account_premium_more: 'Больш падрабязна пра TUB Premium',
    account_limited: 'Вы дасягнулі максімальнага ліміту. Павялічце ліміт з акаўнтам TUB Premium. Падрабязней на сайце <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: 'Устаноўленыя з TUB',
    ...
    change_source_on_cub: 'Змяніць крыніцу на TUB',
    ...
    ad_disable: 'Падпісаўшыся на TUB Premium, вы забудзецеся аб рэкламе.',
    ...
    ai_search_limit: 'Ліміт запытаў перавышаны. Паспрабуйце паўтарыць запыт пазней. З падпіскай TUB Premium ліміты будуць павялічаны, і вам не давядзецца чакаць!',
    ai_subscribe_title: 'Адкрыйце больш магчымасцяў з AI',
    ai_subscribe_descr: 'Аформіце падпіску TUB Premium і павялічце колькасць запытаў да AI. Разам з AI мы падбяром для вас найлепшыя фільмы, якія толькі зможам.',
