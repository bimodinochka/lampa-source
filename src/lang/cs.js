export default {
    ...
    settings_cub_sync_descr: "Synchronizace se službou TUB: synchronizace vašich záložek, historie sledování, značek a časových kódů.",
    ...
    settings_cub_sync_btn_descr: "Uložit místní záložky do účtu TUB",
    ...
    lampa_movie_descr: "Sledujte novinky na svém smartphonu. <br>Telegram: <b>@tub_movie</b>",
    ...
    plugins_load_from: "Načteno z TUB",
    ...
    account_create: 'Otevřete více možností s účtem TUB. Zaregistrujte se na webu <span class="account-modal__site">{site}</span> a získejte přístup k synchronizaci vašich záložek, časových kódů a dalších možností účtu TUB.',
    account_premium: "Otevřete nové obzory s účtem TUB Premium! Užijte si zvýšené limity a obohacenou funkčnost služby. Další možnosti na vás čekají již dnes",
    account_premium_more: "Více o TUB Premium",
    account_limited: 'Dosáhli jste maximálního limitu. Zvýšte limit s účtem TUB Premium. Více na webu <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: "Nainstalováno z TUB",
    ...
    change_source_on_cub: "Změnit zdroj na TUB",
    ...
    ad: "Reklama",
    ad_disable: "Předplatným TUB Premium zapomenete na reklamu.",
    ad_after: "Reklama za",
    ad_skip: "Přeskočit",
    ...
    ai_search_limit: 'Překročen limit dotazů. Zkuste to prosím znovu později. S předplatným TUB Premium se limity zvýší a nebudete muset čekat!',
    ai_subscribe_title: 'Odemkněte více možností s AI',
    ai_subscribe_descr: 'Předplaťte si TUB Premium a zvyšte počet dotazů na AI. Společně s AI pro vás vybereme ty nejlepší filmy, jaké můžeme najít.',
