export default {
    ...
    settings_cub_sync_descr: 'Синхронізація із сервісом TUB: синхронізація ваших закладок, історії переглядів, міток та тайм-кодів.',
    ...
    settings_cub_sync_btn_descr: 'Зберегти локальні закладки в обліковий запис TUB',
    ...
    lampa_movie_descr: 'Слідкуйте за новинками на своєму смартфоні. <br>Телеграм: <b>@tub_movie</b>',
    ...
    plugins_load_from: 'Завантажено із TUB',
    ...
    account_create: 'Відкрийте більше можливостей з облікового запису TUB. Зареєструйтесь на сайті <span class="account-modal__site">{site}</span> та отримайте доступ до синхронізації ваших закладок, тайм-кодів та інших можливостей облікового запису TUB.',
    account_premium: 'Розкрийте нові горизонти з обліковим записом TUB Premium! Насолоджуйтесь збільшеними лімітами та збагаченим функціоналом сервісу. Додаткові можливості чекають на вас вже сьогодні!',
    account_premium_more: 'Докладніше про TUB Premium',
    account_limited: 'Ви досягли максимального ліміту. Збільште ліміт з обліковим записом TUB Premium. Докладніше на сайті <span class="account-modal__site">{site}/premium</span>',
    ...
    extensions_from_cub: 'Встановлені з TUB',
    ...
    change_source_on_cub: 'Змінити джерело на TUB',
    ...
    ad_disable: 'Підписавшись на TUB Premium, ви забудете про рекламу.',
    ...
    ai_search_limit: 'Ліміт запитів перевищено. Спробуйте повторити запит пізніше. З підпискою TUB Premium ліміти будуть збільшені, і вам не доведеться чекати!',
    ai_subscribe_title: 'Відкрийте більше можливостей з AI',
    ai_subscribe_descr: 'Оформіть підписку TUB Premium та збільшіть кількість запитів до AI. Разом з AI ми підберемо для вас найкращі фільми, які тільки зможемо.',
